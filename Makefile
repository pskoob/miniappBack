...
generate:
	...
	@swagger generate client -f ./internal/api/api.swagger.yaml -t ./internal/api  --skip-tag-packages --skip-models --existing-models=github.com/pskoob/miniappBack/internal/api/definition -P models.Principal
	@swagger generate server -f ./internal/api/api.swagger.yaml -t ./internal/api/server --exclude-main --skip-tag-packages --skip-models --api-package=api --existing-models=github.com/pskoob/miniappBack/internal/api/definition -P models.Principal
